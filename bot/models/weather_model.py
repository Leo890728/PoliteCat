...
class EarthquakeReport(SQLModel, table=True):
    ...
    def create_earthquake_report_embed(self) -> discord.Embed:
        ...
        embed.add_field(name=self.magnitude_type, value=str(self.magnitude_value), inline=True)
        embed.add_field(name="深度", value=str(self.focal_depth), inline=True)
