...
class Place:
    ...
    def create_embed(self) -> discord.Embed:
        ...
        embed.set_image(
            url="https://maps.geoapify.com/v1/staticmap?style={2}&width=600&height=400&center=lonlat:{0},{1}&zoom=10&apiKey={3}".format(*self.geo, map_style, os.getenv("GEOAPIFY_API_KEY")))
