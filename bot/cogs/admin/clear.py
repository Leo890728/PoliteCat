...
class ClearCog(BaseCog, name="管理"):
    ...
    @discord.option(
        "message_id",
        str,
        name_localizations=_("訊息id"),
        description_localizations=_("要刪除的訊息 ID"),
    )
    @discord.option(
        "reason",
        str,
        name_localizations=_("原因"),
        description_localizations=_("刪除訊息的原因"),
        default="",
    )
    ...
    @discord.option(
        ...
        str,
        name_localizations=_("原因"),
        description_localizations=_("原因"),
        default=None,
    )
    @discord.option(
        "member",
        Member,
        name_localizations=_("成員"),
        description_localizations=_("要刪除的成員訊息"),
        default=None,
    )
    @discord.option(
        "count",
        int,
        name_localizations=_("數量"),
        description_localizations=_("輸入要刪除的訊息數量"),
        min_value=1,
        max_value=512,
    )
    @discord.option(
        "before",
        str,
        name_localizations=_("以前"),
        description_localizations=_("刪除這則訊息以前的訊息(請輸入訊息ID)"),
        default=None,
    )
    @discord.option(
        "after",
        str,
        name_localizations=_("之後"),
        description_localizations=_("刪除以這則訊息以後的訊息(請輸入訊息ID)"),
        default=None,
    )
    async def purge(
        self,
